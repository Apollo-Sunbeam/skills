...
- **[remove-slides-speaker-notes](./remove-slides-speaker-notes/SKILL.md)** — Generate a Google Apps Script that strips speaker notes from every slide in a Google Slides deck, runnable from a custom toolbar menu.
